...
model = load_model(r"D:\Semester 7\PMDPM - A\Pert - 14 Convolution Neural Networks (Praktek)\Tugas6_A_11478\model_mobilenet.h5")
...
st.title("Prediksi Kematangan Buah Naga - 1478")
